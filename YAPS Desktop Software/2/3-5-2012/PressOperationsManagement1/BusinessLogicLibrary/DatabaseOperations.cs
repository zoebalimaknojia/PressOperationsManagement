...
namespace BusinessLogicLibrary
{
    public class DatabaseOperations
    {
        ...
        public int executeInsUpdDelQuery(string selectQuery)
        {
            try
            {
                SqlConnection connection = DatabaseConnection.getConnection();
        ...
        public void executeDatabaseRestore(string selectQuery)
        {
            try
            {
                SqlConnection connection = DatabaseConnection.getConnection();
        ...
        public void setDatabaseOffline(string selectQuery)
        {
            try
            {
                SqlConnection connection = DatabaseConnection.getConnection();
        ...
        public void setDatabaseOnline(string selectQuery)
        {
            try
            {
                SqlConnection connection = DatabaseConnection.getConnection();
