...
namespace BusinessLogicLibrary
{
    public class DatabaseConnection
    {
        public static SqlConnection getConnection()
        {
            ...
            try
            {
                connectionInstance.ConnectionString = @"Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=PressOperationsManagement;Data Source=" + (PRIMARY_SERVER.Split('='))[1].Trim() + "\\SQLEXPRESS";
            ...
            catch(SqlException exception)
            {
                try
                {
                    connectionInstance.ConnectionString = @"Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=PressOperationsManagement;Data Source=" + (SECONDARY_SERVER.Split('='))[1].Trim() + "\\SQLEXPRESS";
                    connectionInstance.Open();
                    connectionInstance.Close();
